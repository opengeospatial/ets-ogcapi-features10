...
image::images/welcome-ogccite-01.png[]

Login with user and password 'ogctest'

image::images/login-ogccite-02.png[]

Create a new session from the list

image::images/test-session-ogccite-03.png[]

Choose 'OGC' organization then Specification 'Web Feature Service (WFS) - 3.0 [ 0.4 ]'

image::images/complete-test-session-ogccite-04.png[]
...
image::images/wfs-conformance-test-suite-ogccite-05.png[]

Wait test execution and see the results from the validator

image::images/result-wfs-test-suite-ogccite-06.png[]
