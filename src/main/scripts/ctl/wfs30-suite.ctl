...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
             ...
             xmlns:tns="http://www.opengis.net/cite/wfs30"
             xmlns:saxon="http://saxon.sf.net/"
             xmlns:tec="java:com.occamlab.te.TECore"
             xmlns:tng="java:org.opengis.cite.wfs30.TestNGController">
  ...
  <ctl:function name="tns:run-ets-${ets-code}">
    ...
    <ctl:description>Runs the WFS 3.0 (${version}) test suite.</ctl:description>
    <ctl:code>
  ...
  <ctl:suite name="tns:ets-${ets-code}-${version}">
    <ctl:title>WFS 3.0 Conformance Test Suite</ctl:title>
    <ctl:description>Checks WFS 3.0 implementations for conformance.</ctl:description>
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          <h2>WFS 3.0 Conformance Test Suite</h2>
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            <p>The implementation under test (IUT) is checked against the following specifications:</p>
            <ul>
              <li>
                <a href="https://github.com/opengeospatial/WFS_FES">Web Feature Service 3.0</a>
              </li>
            </ul>
