...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  <ctl:function name="tns:run-ets-wfs30">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the wfs30 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-wfs30-${version}">
     <ctl:title>Test suite: ets-wfs30</ctl:title>
   ...
   <ctl:test name="tns:Main">
	  ...
	  <ctl:code>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-wfs30">
