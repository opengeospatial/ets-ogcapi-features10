...
public class UrnValidator {
	 ...
	 *
	 * @see <a href="https://en.wikipedia.org/wiki/Uniform_Resource_Name">Wiki: Uniform
	 * Resource Name</a>
	 */
	 ...
	 * </pre>
	 *
	 * The order is not gurantee as the '?' can be used in fragment, and the '+' and '='
	 * can be used in pchar.
	 *
	 * @see #R_Q_COMPONENT
	 */
