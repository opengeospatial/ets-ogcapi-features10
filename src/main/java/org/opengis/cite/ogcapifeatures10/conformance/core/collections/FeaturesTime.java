...
public class FeaturesTime extends AbstractFeatures {
	...
	public Iterator<Object[]> collectionItemUrisWithDateTimes(ITestContext testContext) {
		...
		for (Map<String, Object> collection : collections) {
			...
			if (temporalExtent != null) {
				...
				collectionsWithTimes
					.add(new Object[] { collection, formatDateRangeWithDuration(beginIntervalDate, endIntervalDate),
	 ...
	 * <code>null</code>
	 * @param begin a {@link ZonedDateTime} or {@link LocalDate}, the begin of the
	 * interval (or instant), never <code>null</code>
	 * @param end a {@link ZonedDateTime} or {@link LocalDate}, the end of the interval,
	...
	public void validateFeaturesWithDateTimeOperation(Map<String, Object> collection, String queryParameter,
		...
		Response response = init().baseUri(getFeaturesUrl)
			.accept(GEOJSON_MIME_TYPE)
			.param("datetime", queryParameter)
			.when()
			.request(GET);
	...
	public void validateFeaturesWithDateTimeResponse_GeometryInCRS84(Map<String, Object> collection,
			String queryParameter, Object begin, Object end) throws ParseException {
		String collectionId = (String) collection.get("id");
	...
	public void validateFeaturesWithDateTimeResponse_NumberMatched(Map<String, Object> collection,
			String queryParameter, Object begin, Object end) throws URISyntaxException {
		String collectionId = (String) collection.get("id");
