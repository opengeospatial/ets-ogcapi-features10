...
public class FeatureCollection extends CommonDataFixture {
	...
	public Object[][] collections(ITestContext testContext) {
		List<Map<String, Object>> testPointAndCollections = (List<Map<String, Object>>) testContext.getSuite()
			.getAttribute(COLLECTIONS.getName());
	 ...
	 */
	@Test(description = "Implements A.2.6. Feature Collection {root}/collections/{collectionId}, Abstract Test 11 (Requirement /req/core/sfc-md-op)",
			groups = "collection", dataProvider = "collections", dependsOnGroups = { "collections" })
