...
public class DiscoveryCollectionsStorageCrsTest {
	...
	/**
	 * Test a collection whose crs contains only the global {@code #/crs} pointer, and the
	 * global crs property contains the collection's storageCrs
	 */
	@Test
	...
	/**
	 * Test a collection whose storageCrs is declared in the global crs but not on its crs
	 * property, but it does contain the global {@code #/crs} pointer.
	 */
	@Test
	...
	/**
	 * Test a collection whose storageCrs is not declared in its crs and has no pointer to
	 * the global crs
	 */
